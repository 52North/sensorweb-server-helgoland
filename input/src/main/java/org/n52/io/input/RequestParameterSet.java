...
public abstract class RequestParameterSet {
    ...
    public void setGeneralize(boolean generalize) {
        parameters.put(Parameters.GENERALIZE, IoParameters.getJsonNodeFrom(generalize));
    }
    ...
    public void setTimespan(String timespan) {
        ...
        parameters.put(Parameters.TIMESPAN, IoParameters.getJsonNodeFrom(timespan));
    }
    ...
    public void setBase64(boolean base64) {
        parameters.put(Parameters.BASE_64, IoParameters.getJsonNodeFrom(base64));
    }
    ...
    public void setExpanded(boolean expanded) {
        parameters.put(Parameters.EXPANDED, IoParameters.getJsonNodeFrom(expanded));
    }
    ...
    public void setLocale(String locale) {
        locale = !(locale == null || locale.isEmpty())
                ? locale
                : "en";
        parameters.put(Parameters.LOCALE, IoParameters.getJsonNodeFrom(locale));
    }
