...
public class DefaultIoFactory<O extends DatasetOutput<V>, V extends AbstractValue<?>>
        extends ConfigTypedFactory<IoFactory<O, V>> {
    ...
    @Override
    protected IoFactory<O, V> initInstance(IoFactory<O, V> instance) {
        return instance;
    }
