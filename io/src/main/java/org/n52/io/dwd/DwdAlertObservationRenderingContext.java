...
public final class DwdAlertObservationRenderingContext implements RenderingContext<DwdAlertObservationSeriesOutput> {
    private final RequestStyledParameterSet chartStyleDefinitions;

    private final List<DwdAlertObservationSeriesOutput> seriesMetadatas;

    // use static constructors
    private DwdAlertObservationRenderingContext(RequestStyledParameterSet timeseriesStyles, List<DwdAlertObservationSeriesOutput> metadatas) {
        this.seriesMetadatas = metadatas.isEmpty()
                ? Collections.<DwdAlertObservationSeriesOutput>emptyList()
                : metadatas;
        this.chartStyleDefinitions = timeseriesStyles;
    }

    public static DwdAlertObservationRenderingContext createEmpty() {
        List<DwdAlertObservationSeriesOutput> emptyList = Collections.emptyList();
        return new DwdAlertObservationRenderingContext(new RequestStyledParameterSet(), emptyList);
    }
     ...
     * @return a rendering context to be used by {@link DwdAlertObservationIoFactory} to create an
     * {@link IoHandler}.
     */
    public static DwdAlertObservationRenderingContext createContextWith(RequestStyledParameterSet styles,
            List<DwdAlertObservationSeriesOutput> metadatas) {
        ...
        return new DwdAlertObservationRenderingContext(styles, metadatas);
    }

    public static DwdAlertObservationRenderingContext createContextForSingleSeries(DwdAlertObservationSeriesOutput metadata, IoParameters ioConfig) {
    ...
    public List<DwdAlertObservationSeriesOutput> getSeriesMetadatas() {
