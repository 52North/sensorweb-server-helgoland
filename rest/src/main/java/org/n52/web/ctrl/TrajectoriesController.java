...
public class TrajectoriesController extends AbstractDatasetController {

    @Autowired
    public TrajectoriesController(CountingMetadataService counter, ParameterService<DatasetOutput<?>> service) {
