...
public abstract class SeriesDataControllerService {
    ...
    public abstract SeriesDataCollection<?> format(SeriesDataCollection seriesData, String format);

    public abstract SeriesDataCollection getSeriesData(RequestSimpleParameterSet parameters);
}
