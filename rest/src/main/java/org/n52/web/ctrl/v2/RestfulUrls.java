...
public interface RestfulUrls {
     ...
     */
    static final String API_VERSION_PATH = "/v2";

    /**
     * Subpath identifying a collection of services availabe.
     */
    public static final String COLLECTION_SERVICES = API_VERSION_PATH + "/services";
     ...
     */
    static final String COLLECTION_SERIES = API_VERSION_PATH + "/series";
