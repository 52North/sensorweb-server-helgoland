...
public class UpdateAlertStoreJob extends ScheduledJob implements InterruptableJob, ServletConfigAware {
    ...
    public JobDetail createJobDetails() {
        return JobBuilder.newJob(UpdateAlertStoreJob.class).withIdentity(getJobName()).withDescription(getJobDescription())
               .build();
    }
