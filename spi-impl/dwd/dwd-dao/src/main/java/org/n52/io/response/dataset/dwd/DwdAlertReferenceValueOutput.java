...
public class DwdAlertReferenceValueOutput implements ReferenceValueOutput<DwdAlertValue> {

    private String referenceValueId;

    private String label;

    private DwdAlertValue lastValue;
    ...
    @Override
    public DwdAlertValue getLastValue() {
        return lastValue;
    }

    @Override
    public void setLastValue(DwdAlertValue lastValue) {
