...
public class ExampleConstants {
    ...
    public static final String BASE_URL = "http://link.to/api/v1";

    public static final ServiceOutput service = createService();

    private static ServiceOutput createService() {
