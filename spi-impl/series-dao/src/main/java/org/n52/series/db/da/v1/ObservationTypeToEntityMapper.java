...
class ObservationTypeToEntityMapper {
    Class<? extends AbstractSeriesEntity> mapToEntityClass(ObservationType type) {
        switch (type) {
            case TEXT:
                return TextObservationSeriesEntity.class;
            case COUNT:
                return CountObservationSeriesEntity.class;
            case MEASUREMENT:
                return MeasurementSeriesEntity.class;
            default:
                return AbstractSeriesEntity.class;
        }
    }
}
