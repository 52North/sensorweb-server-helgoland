...
public class MeasurementDatasetTEntity extends DatasetTEntity<MeasurementDataEntity> {

    private int numberOfDecimals;

    private Set<MeasurementDatasetTEntity> referenceValues = new HashSet<>();

    public Set<MeasurementDatasetTEntity> getReferenceValues() {
        return referenceValues;
    }

    public void setReferenceValues(Set<MeasurementDatasetTEntity> referenceValues) {
