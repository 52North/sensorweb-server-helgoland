...
public class ProfileDataItemTest {
    ...
    public void getVerticalFrom_when_verticalFromIsNull() {
        ProfileDataItem<Object> value = new ProfileDataItem<>(BigDecimal.valueOf(1L), null);
    ...
    public void getVerticalFrom_when_verticalFromIsNotNull() {
        ProfileDataItem<Object> value = new ProfileDataItem<>(BigDecimal.valueOf(1L), BigDecimal.valueOf(2L), null);
