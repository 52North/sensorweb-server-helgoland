						...
						<xsl:for-each select="$XML">
							<xsl:for-each select="n52:DocumentStructure">
								...
								<xsl:for-each select="n52:TimeSeries">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>Sensor Standort</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
											...
											<fo:table-row>
												<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>Sensor Phänomen</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
									...
									<fo:inline font-weight="bold">
										<xsl:text>Metadaten der Zeitreihe:</xsl:text>
									</fo:inline>
									<fo:inline-container>
										<fo:block>
											<xsl:text>&#x2029;</xsl:text>
									...
									<fo:inline font-weight="bold">
										<xsl:text>Sensor Daten:</xsl:text>
									</fo:inline>
									<fo:inline-container>
										<fo:block>
											<xsl:text>&#x2029;</xsl:text>
