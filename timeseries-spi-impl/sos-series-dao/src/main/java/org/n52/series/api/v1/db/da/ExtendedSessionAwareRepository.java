	...
	protected ExtendedSessionAwareRepository(ServiceInfo serviceInfo) {
	 ...
	 protected Map<String, TimeseriesOutput> createTimeseriesList(List<SeriesEntity> series, DbQuery parameters) throws DataAccessException {
	    ...
	    protected ServiceOutput getServiceOutput() throws DataAccessException {
	        ...
	        List<org.n52.io.response.v1.ServiceOutput> all = serviceRepository.getAllCondensed(null);
	    ...
	    protected org.n52.io.response.v1.ServiceOutput getCondensedService() throws DataAccessException {
	        ...
	        org.n52.io.response.v1.ServiceOutput instance = serviceRepository.getCondensedInstance(serviceId);
