...
public class SeriesEntityV2 {
    ...
    private List<ObservationEntityV2> observations = new ArrayList<ObservationEntityV2>();

    private Set<SeriesEntityV2> referenceValues = new HashSet<SeriesEntityV2>();

    private ObservationEntityV2 firstValue;

    private ObservationEntityV2 lastValue;
    ...
    public List<ObservationEntityV2> getObservations() {
        return observations;
    }

    public void setObservations(List<ObservationEntityV2> observations) {
        this.observations = observations;
    }

    public Set<SeriesEntityV2> getReferenceValues() {
        return referenceValues;
    }

    public void setReferenceValues(Set<SeriesEntityV2> referenceValues) {
    ...
    public void setFirstValue(ObservationEntityV2 firstValue) {
    ...
    public void setLastValue(ObservationEntityV2 lastValue) {
